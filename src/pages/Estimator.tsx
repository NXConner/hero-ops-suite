...
const Estimator = () => {
  ...
  const textInvoice = useMemo(() => {
    ...
    lines.push("");
    lines.push("Labor:");
    result.labor.forEach((l) =>
      lines.push(`- ${l.label}: ${formatMoney(l.cost)}${l.notes ? ` (${l.notes})` : ""}`),
    );
    lines.push("");
    lines.push("Equipment & Fuel:");
    result.equipmentAndFuel.forEach((e) =>
      lines.push(`- ${e.label}: ${formatMoney(e.cost)}${e.notes ? ` (${e.notes})` : ""}`),
    );
    lines.push("");
    ...
    if (result.transportLoad) {
      lines.push("");
      lines.push(
        `Transport Load: ~${result.transportLoad.totalWeightLbs} lbs. ${result.transportLoad.exceedsLikelyGvwr ? "Check GVWR!" : ""}`,
      );
  ...
  const handleComputeSupplierMiles = async () => {
    const miles = await computeRoundTripMilesBetween(
      BUSINESS_PROFILE.address.full,
      BUSINESS_PROFILE.supplier.address.full,
    );
  ...
  const handleLoadJob = (j: StoredJob) => {
    ...
    setRoundTripMilesSupplier(
      j.params.roundTripMilesSupplier ?? BUSINESS_PROFILE.travelDefaults.roundTripMilesSupplier,
    );
  ...
  const composeStructuredAddress = () => {
    const parts = [jobStreet, jobCity, jobState, jobZip]
      .map((s) => (s || "").trim())
      .filter(Boolean);
    return parts.join(", ");
  };
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
                ...
                <div className="flex gap-2 justify-end">
                  <Button type="button" variant="outline" onClick={handleSaveJob}>
                    Save Job
                  </Button>
                  <Button type="button" onClick={() => navigator.clipboard.writeText(textInvoice)}>
                    Copy Invoice
                  </Button>
                  <Button
                    type="button"
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                  <Input
                    ...
                    onBlur={handleStructuredAddressBlur}
                  />
                  <Input
                    placeholder="City"
                    value={jobCity}
                ...
                <div className="mt-2">
                  ...
                  <div className="text-xs text-muted-foreground mt-1">
                    Use My Location will override structured fields.
                  </div>
                </div>
                <div className="mt-2 flex gap-2">
                  ...
                  <Button type="button" variant="outline" onClick={handleComputeJobMiles}>
                    Auto Miles
                  </Button>
                </div>
              </div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setParams((p) => ({
                          ...p,
                          sealcoatSquareFeet: 18000,
                          patchSquareFeet: 200,
                          crackLinearFeet: 800,
                          numStandardStalls: 90,
                          numDoubleStalls: 10,
                        }));
                      }}
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Select
                    value={(params as any).stallSize || "standard"}
                    onValueChange={(v) => setParams((p) => ({ ...p, stallSize: v }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    value={params.paintColor}
                    onValueChange={(v) => setParams((p) => ({ ...p, paintColor: v }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      {(BUSINESS_PROFILE.pricing.paintColors ?? ["yellow", "white", "blue"]).map(
                        (c) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <Input
                    type="number"
                    min={0}
                    value={params.sealcoatSquareFeet}
                    onChange={(e) =>
                      setParams((p) => ({
                        ...p,
                        sealcoatSquareFeet: Math.max(0, Number(e.target.value) || 0),
                      }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    min={0}
                    value={params.patchSquareFeet}
                    onChange={(e) =>
                      setParams((p) => ({
                        ...p,
                        patchSquareFeet: Math.max(0, Number(e.target.value) || 0),
                      }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    min={0}
                    value={params.crackLinearFeet}
                    onChange={(e) =>
                      setParams((p) => ({
                        ...p,
                        crackLinearFeet: Math.max(0, Number(e.target.value) || 0),
                      }))
                    }
                  />
                </div>
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      type="number"
                      min={0}
                      value={params.oilSpotSquareFeet}
                      onChange={(e) =>
                        setParams((p) => ({
                          ...p,
                          oilSpotSquareFeet: Math.max(0, Number(e.target.value) || 0),
                        }))
                      }
                    />
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (area > 0)
                          setParams((p) => ({ ...p, oilSpotSquareFeet: Math.round(area) }));
                      }}
                    >
                      Use map
                    </Button>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={(e) =>
                      setParams((p) => ({
                        ...p,
                        crackHours: Math.max(0, Number(e.target.value) || 0),
                      }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onBlur={(e) =>
                      setParams((p) => ({
                        ...p,
                        propaneCostPerHour: Math.max(0, Number(e.target.value) || 0),
                      }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    value={params.numStandardStalls}
                    onChange={(e) =>
                      setParams((p) => ({ ...p, numStandardStalls: Number(e.target.value) }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    value={params.numDoubleStalls}
                    onChange={(e) =>
                      setParams((p) => ({ ...p, numDoubleStalls: Number(e.target.value) }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    value={params.numHandicapSpots}
                    onChange={(e) =>
                      setParams((p) => ({ ...p, numHandicapSpots: Number(e.target.value) }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    value={params.numCrosswalks}
                    onChange={(e) =>
                      setParams((p) => ({ ...p, numCrosswalks: Number(e.target.value) }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    value={(params as any).numStopBars || 0}
                    onChange={(e) =>
                      setParams((p) => ({ ...p, numStopBars: Number(e.target.value) }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    value={(params as any).numTextStencils || 0}
                    onChange={(e) =>
                      setParams((p) => ({ ...p, numTextStencils: Number(e.target.value) }))
                    }
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      type="number"
                      min={0}
                      value={roundTripMilesSupplier}
                      onChange={(e) =>
                        setRoundTripMilesSupplier(Math.max(0, Number(e.target.value) || 0))
                      }
                    />
                    <Button type="button" variant="outline" onClick={handleComputeSupplierMiles}>
                      Auto
                    </Button>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      type="number"
                      min={0}
                      value={roundTripMilesJob}
                      onChange={(e) =>
                        setRoundTripMilesJob(Math.max(0, Number(e.target.value) || 0))
                      }
                    />
                    <Button type="button" variant="outline" onClick={handleComputeJobMiles}>
                      Auto
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={(e) =>
                      setParams((p) => ({
                        ...p,
                        trailerMpgModifierPct: (Number(e.target.value) || 0) / 100,
                      }))
                    }
                  />
                </div>
                <div className="col-span-1 md:col-span-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-2 items-end">
                    <Select
                      value={legBased ? "yes" : "no"}
                      onValueChange={(v) => setLegBased(v === "yes")}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                    ...
                    <Input
                      disabled={!legBased}
                      placeholder="C30 total miles"
                      value={legC30Total}
                      onChange={(e) => setLegC30Total(Number(e.target.value) || "")}
                    />
                    <Input
                      disabled={!legBased}
                      placeholder="C30 loaded miles"
                      value={legC30Loaded}
                      onChange={(e) => setLegC30Loaded(Number(e.target.value) || "")}
                    />
                    <Input
                      disabled={!legBased}
                      placeholder="Dakota total miles"
                      value={legDakotaTotal}
                      onChange={(e) => setLegDakotaTotal(Number(e.target.value) || "")}
                    />
                  </div>
                </div>
                <div>
                  ...
                  <Select
                    value={(params as any).applicationMethod || "spray"}
                    onValueChange={(v) => setParams((p) => ({ ...p, applicationMethod: v as any }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      step="0.01"
                      value={pmmPrice}
                      onChange={(e) => setPmmPrice(Math.max(0, Number(e.target.value) || 0))}
                    />
                    <Select
                      onValueChange={(v) =>
                        setPmmPrice(
                          v === "bulk"
                            ? BUSINESS_PROFILE.materials.pmmBulkPricePerGallon
                            : BUSINESS_PROFILE.materials.pmmPricePerGallon,
                        )
                      }
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="default">
                          Default ${BUSINESS_PROFILE.materials.pmmPricePerGallon.toFixed(2)}
                        </SelectItem>
                        <SelectItem value="bulk">
                          Bulk ${BUSINESS_PROFILE.materials.pmmBulkPricePerGallon.toFixed(2)}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div>
                  ...
                  <Input
                    type="number"
                    value={numFullTime}
                    onChange={(e) => setNumFullTime(Number(e.target.value))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    value={numPartTime}
                    onChange={(e) => setNumPartTime(Number(e.target.value))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    step="0.5"
                    value={sealerActiveHours}
                    onChange={(e) => setSealerActiveHours(Number(e.target.value))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    type="number"
                    step="0.5"
                    value={excessiveIdleHours}
                    onChange={(e) => setExcessiveIdleHours(Number(e.target.value))}
                  />
                </div>
                <div>
                  <Label>Transport weight check</Label>
                  <Select
                    value={includeWeightCheck ? "yes" : "no"}
                    onValueChange={(v) => setIncludeWeightCheck(v === "yes")}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    value={(params as any).applySalesTax ? "yes" : "no"}
                    onValueChange={(v) => setParams((p) => ({ ...p, applySalesTax: v === "yes" }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <Select
                    value={String((params as any).multiCoat || 1)}
                    onValueChange={(v) => setParams((p) => ({ ...p, multiCoat: Number(v) }))}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={(e) =>
                      setParams((p) => ({
                        ...p,
                        wasteFactorPct: (Number(e.target.value) || 0) / 100,
                      }))
                    }
                  />
                </div>
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Select
                      value={(params as any).tackCoat ? "yes" : "no"}
                      onValueChange={(v) => setParams((p) => ({ ...p, tackCoat: v === "yes" }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                    ...
                    <Select
                      value={(params as any).additives ? "yes" : "no"}
                      onValueChange={(v) => setParams((p) => ({ ...p, additives: v === "yes" }))}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setParams((p) => ({
                              ...p,
                              numHandicapSpots: Math.max(0, Number(e.target.value) || 0),
                            }))
                          }
                        />
                      </div>
              ...
              <div className="mt-3 flex gap-2 justify-end">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setComplianceState(v as StateCode)}
                  >
                ...
                <Button
                  ...
                  onClick={() => {
                    const subject = encodeURIComponent(
                      `${jobName || "Estimate"} - Asphalt Estimate`,
                    );
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            onClick={() => setJobAddress(p.address)}
                          >
                            Use Address
                          </Button>
                        </div>
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            variant="outline"
                            size="sm"
                            onClick={() => setJobAddress(c.address)}
                          >
                            Use
                          </Button>
                        </div>
