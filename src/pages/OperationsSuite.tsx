  ...
  return (
    <div className="p-4 space-y-3">
      <div className="flex gap-2">
        <button className="px-3 py-1 rounded bg-secondary" onClick={() => setPath("/suite/")}>
          Operations Home
        </button>
        <button className="px-3 py-1 rounded bg-secondary" onClick={() => setPath("/suite/fleet/")}>
          Fleet Focus Manager
        </button>
        <button className="px-3 py-1 rounded bg-secondary" onClick={() => setPath("/suite/atlas/")}>
          Atlas Hub
        </button>
        <button
          className="px-3 py-1 rounded bg-secondary"
          onClick={() => setPath("/suite/mapper/")}
        >
          Patrick County Mapper
        </button>
        <button
          className="px-3 py-1 rounded bg-secondary"
          onClick={() => setPath("/suite/weather/")}
        >
          Weather Cast
        </button>
      </div>
