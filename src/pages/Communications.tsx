  ...
  const messages = [
    {
      ...
      message:
        "Alpha Team, proceed to checkpoint Charlie and maintain radio silence until further notice.",
      timestamp: "14:32",
      type: "command",
      encrypted: true,
      status: "delivered",
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="bg-card/50 backdrop-blur-sm border border-border/50">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Quick access to critical communication channels
                    </CardDescription>
                  </CardHeader>
                ...
                <Card className="bg-card/50 backdrop-blur-sm border border-border/50">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea id="message" placeholder="Enter emergency message..." rows={4} />
                    </div>
            ...
            <TabsContent value="logs" className="space-y-6">
              <Card className="bg-card/50 backdrop-blur-sm border border-border/50">
                <CardHeader>
                  ...
                  <CardDescription>
                    Historical communication records and audit trail
                  </CardDescription>
                </CardHeader>
                <CardContent>
