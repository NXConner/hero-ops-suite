...
export const BUSINESS_PROFILE: BusinessProfile = {
  ...
  trailers: [
    { name: "8ft black utility trailer", lengthFt: 8, type: "utility", notes: "4 crack machines, propane, crack filler, sand, 2 push blowers, LW crack clear, tools" },
    { name: "10ft black utility trailer", lengthFt: 10, type: "utility", notes: "Similar load as 8ft trailer" },
