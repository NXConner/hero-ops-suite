...
const DefectMarkers: React.FC<{ defects: DefectData[]; showDefects: boolean }> = ({
  defects,
  showDefects,
}) => {
    ...
    <div className="space-y-4">
          ...
          <Tabs defaultValue="display" className="w-full">
            ...
            <TabsContent value="display" className="space-y-4 mt-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch id="surface" checked={showSurface} onCheckedChange={setShowSurface} />
                  <Label htmlFor="surface">Surface Mesh</Label>
                </div>

                <div className="flex items-center space-x-2">
                  <Switch id="defects" checked={showDefects} onCheckedChange={setShowDefects} />
                ...
                {defects.length > 0 ? (
                  defects.map((defect) => (
                    ...
                    >
                      ...
                      <Badge variant="outline">{(defect.confidence * 100).toFixed(0)}%</Badge>
                    </div>
                  ))
                ) : (
                  ...
                  <CardContent className="p-4">
                    <div className="text-center">
                      <p className="text-2xl font-bold">
                        {scanData?.perimeter.toFixed(1) || "0.0"}
                      </p>
      ...
      <Card className={fullscreen ? "fixed inset-0 z-50" : ""}>
        <CardContent className="p-0">
          <div
            className={`bg-gray-900 ${fullscreen ? "h-screen" : "h-96"} rounded-lg overflow-hidden`}
          >
            <Canvas>
              <Suspense fallback={null}>
                ...
                {/* Surface Mesh */}
                <SurfaceMesh points={pointCloud} showSurface={showSurface} wireframe={wireframe} />
