                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          value={[
                            parseInt(
                              ((customTheme as any).ui?.radius?.menu || "6px").toString(),
                              10,
                            ),
                          ]}
                          onValueChange={([v]) => {
                            ...
                            updated.ui = {
                              ...(updated.ui || {}),
                              radius: { ...(updated.ui?.radius || {}), menu: `${v}px` },
                            };
                            setCustomTheme(updated);
                            const s = document.getElementById("preview-theme-styles");
                            const style = s || document.createElement("style");
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          value={[
                            parseInt(
                              ((customTheme as any).ui?.radius?.popover || "6px").toString(),
                              10,
                            ),
                          ]}
                          onValueChange={([v]) => {
                            ...
                            updated.ui = {
                              ...(updated.ui || {}),
                              radius: { ...(updated.ui?.radius || {}), popover: `${v}px` },
                            };
                            setCustomTheme(updated);
                            const s = document.getElementById("preview-theme-styles");
                            const style = s || document.createElement("style");
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          value={[
                            parseInt(
                              ((customTheme as any).ui?.radius?.toast || "8px").toString(),
                              10,
                            ),
                          ]}
                          onValueChange={([v]) => {
                            ...
                            updated.ui = {
                              ...(updated.ui || {}),
                              radius: { ...(updated.ui?.radius || {}), toast: `${v}px` },
                            };
                            setCustomTheme(updated);
                            const s = document.getElementById("preview-theme-styles");
                            const style = s || document.createElement("style");
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          value={[
                            parseInt(
                              ((customTheme as any).ui?.radius?.dialog || "8px").toString(),
                              10,
                            ),
                          ]}
                          onValueChange={([v]) => {
                            ...
                            updated.ui = {
                              ...(updated.ui || {}),
                              radius: { ...(updated.ui?.radius || {}), dialog: `${v}px` },
                            };
                            setCustomTheme(updated);
                            const s = document.getElementById("preview-theme-styles");
                            const style = s || document.createElement("style");
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          value={[
                            parseInt(
                              ((customTheme as any).ui?.radius?.tabs || "6px").toString(),
                              10,
                            ),
                          ]}
                          onValueChange={([v]) => {
                            ...
                            updated.ui = {
                              ...(updated.ui || {}),
                              radius: { ...(updated.ui?.radius || {}), tabs: `${v}px` },
                            };
                            setCustomTheme(updated);
                            const s = document.getElementById("preview-theme-styles");
                            const style = s || document.createElement("style");
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          value={[
                            parseInt(
                              ((customTheme as any).ui?.borders?.width || "1px").toString(),
                              10,
                            ),
                          ]}
                          onValueChange={([v]) => {
                            ...
                            updated.ui = {
                              ...(updated.ui || {}),
                              borders: { ...(updated.ui?.borders || {}), width: `${v}px` },
                            };
                            setCustomTheme(updated);
                            const s = document.getElementById("preview-theme-styles");
                            const style = s || document.createElement("style");
                      ...
                      <div>
                        ...
                        <Slider
                          ...
                          value={[
                            parseInt(
                              (
                                (customTheme as any).ui?.borders?.focusRingOffset || "2px"
                              ).toString(),
                              10,
                            ),
                          ]}
