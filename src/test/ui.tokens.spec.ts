  ...
  effects: {
    ...
    gradients: {
      primary: {
        ...
        angle: 135,
        stops: [
          { color: { h: 200, s: 80, l: 50 }, position: 0 },
          { color: { h: 260, s: 60, l: 50 }, position: 100 },
        ],
      },
      secondary: {
        type: "linear",
        angle: 135,
        stops: [
          { color: { h: 180, s: 50, l: 40 }, position: 0 },
          { color: { h: 200, s: 80, l: 50 }, position: 100 },
        ],
      },
      hero: {
        type: "linear",
        angle: 135,
        stops: [
          { color: { h: 220, s: 10, l: 10 }, position: 0 },
          { color: { h: 260, s: 60, l: 50 }, position: 100 },
        ],
      },
      card: {
        ...
        angle: 135,
        stops: [
          { color: { h: 220, s: 10, l: 14 }, position: 0 },
          { color: { h: 220, s: 10, l: 16 }, position: 100 },
        ],
      },
      button: {
        type: "linear",
        ...
        stops: [
          { color: { h: 200, s: 80, l: 50 }, position: 0 },
          { color: { h: 180, s: 50, l: 40 }, position: 100 },
        ],
      },
      border: {
        type: "linear",
        angle: 135,
        stops: [
          { color: { h: 220, s: 10, l: 25 }, position: 0 },
          { color: { h: 220, s: 10, l: 20 }, position: 100 },
        ],
      },
    },
  },
