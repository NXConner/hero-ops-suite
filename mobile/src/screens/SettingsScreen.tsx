  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        onChangeText={(t) => setBrandingState({ ...branding, companyName: t })}
      />
      <Text>Primary Color</Text>
      <TextInput
        style={styles.input}
        value={branding.primary}
        onChangeText={(t) => setBrandingState({ ...branding, primary: t })}
      />
      <Text>Footer Disclaimer</Text>
      <TextInput
        style={styles.input}
        value={branding.footerDisclaimer}
        onChangeText={(t) => setBrandingState({ ...branding, footerDisclaimer: t })}
      />
